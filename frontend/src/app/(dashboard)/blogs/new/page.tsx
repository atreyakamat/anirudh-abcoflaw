    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20">
      ...
      <div className="flex items-center justify-between bg-white/70 backdrop-blur-xl border border-white/50 shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-4 rounded-3xl sticky top-4 z-40">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-xl font-bold font-serif text-slate-900">Create New Post</h1>
        </div>
        <div className="flex items-center gap-3">
          ...
          >
            {createPost.isPending ? <Loader2 className="w-4 h-4 animate-spin" /> : <CheckCircle2 className="w-4 h-4" />}
            Publish Post
          </button>
        </div>
      </div>
