        ...
        <div className="bg-card rounded-xl border p-6 shadow-sm space-y-6">
          ...
          <form onSubmit={handleStaticLogin} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-2.5 bg-primary text-primary-foreground rounded-lg font-medium hover:bg-primary/90 transition-colors disabled:opacity-50 flex items-center justify-center"
            >
          ...
          <div className="flex flex-col items-center">
            <button
              ...
              disabled={isLoading}
              type="button"
              className="w-full flex items-center justify-center gap-3 py-2.5 px-4 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 border border-gray-300 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors shadow-sm disabled:opacity-50"
            >
              {isLoading ? (
            ...
            <p className="text-xs text-muted-foreground mt-4 text-center">
              Internal staff will be redirected to the admin dashboard. Clients will be directed to their customer portal.
            </p>
          </div>
        </div>
